...
const {sendRemoveRequest, acceptDeclineRequest, removeFriend, getFriends, getUser, getAllUsers, getRequests, updateUser, getUserLight, search} = require("../controllers/user");
